...
export const tenderlyOctantFork: Chain = {
  id: 8, // Chain ID for Tenderly
  name: 'Octant Hackathon Mainnet Fork',
  nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
  rpcUrls: {
    default: {
      http: ['https://virtual.mainnet.eu.rpc.tenderly.co/82c86106-662e-4d7f-a974-c311987358ff'],
      webSocket: ['wss://virtual.mainnet.eu.rpc.tenderly.co/87bd6871-7026-486c-9db5-2287b66d0c62'], // Opcional, pero bueno tenerlo
    },
    public: {
      http: ['https://virtual.mainnet.eu.rpc.tenderly.co/82c86106-662e-4d7f-a974-c311987358ff'],
